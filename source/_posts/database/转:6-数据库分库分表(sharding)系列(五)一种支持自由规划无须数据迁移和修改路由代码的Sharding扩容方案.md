title: "转:6-数据库分库分表(sharding)系列(五)一种支持自由规划无须数据迁移和修改路由代码的Sharding扩容方案"
...
![6-图1.Sharding拓扑结构领域模型.jpg](/img/6-图1.Sharding拓扑结构领域模型.jpg)
...
![6-图6.增强后的Sharding拓扑结构领域模型.jpg](/img/6-图6.增强后的Sharding拓扑结构领域模型.jpg)
