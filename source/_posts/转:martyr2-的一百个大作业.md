...
原文地址:
[http://typeof.net/c/100-projects-by-martyr2.html](http://typeof.net/c/100-projects-by-martyr2.html)

原始来源地址:
[www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/](www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/)
...
在过去的几年内我看到不少帖子问自已应该做什么项目。我看到了不少回答，也做了不少，因而积累了一些常见的，你们可以做的小项目。我认为只列两三个主意没什么意思，于是我开始寻找那些常见的、程序员应该学去做的东西。哦，这些不是给你写论文用的，它只是一些沉淀下来的思维火花。
...
在下面你将看到 100 个项目思路。它们是我从头脑风暴里提取出来的。我把它们分成 9 个分类，方便诸位挑选习作。

——Martyr2（[来源](http://www.dreamincode.net/forums/topic/78802-martyr2s-mega-project-ideas-list/)）

<!--more-->

基本上，如果你把下面 100 个大作业都做完了，你就是牛叉的程序猿了。

为了提高各位的英语水平，具体内容没有翻译。（众人：你又在为你的懒惰找借口……）


# 特别注意

* 下面五个项目体量巨大，一个能顶十个，做成产品能名垂青史，也可以用来训练团队管理：
	* File Explorer
...
* 分类在「数学」的，除非是数值计算、数论、密码学等偏重理论的方向，否则可以略去不做
* 「类型抽象」分类下的题目，如果不是传统 OOP 语言，可以略去不做
...
Bank Account Manager NaN Create a class called “Account” which will be an abstract class for three other classes called “CheckingAccount”, “SavingsAccount” and “BusinessAccount”. Manage credits and debits from these accounts through an ATM style program.
...
File Explorer – Create your own file explorer program, with added features, better searching, new icons and other views.
